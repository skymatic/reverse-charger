...
public enum AppleSubsidiary implements Recipient {
	...
	ROW(new String[]{"Apple Distribution International Limited", "Hollyhill Industrial Estate", "Hollyhill, Cork", "Republic of Ireland", "VAT ID: IE9700053D"}),
	NORTHAMERICA(new String[]{"Apple Inc.", "One Apple Park Way", "Cupertino, CA 95014", "USA"}),
	LATINAMERICA(new String[]{"Apple Services LATAM LLC", "One Apple Park Way, MS 169-5CL", "Cupertino, CA 95014", "USA"}),
